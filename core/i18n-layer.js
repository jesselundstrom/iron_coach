...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      'settings.claude_api_key.label': 'Secure account access',
      'settings.claude_api_key.placeholder': '',
      'settings.claude_api_key.help':
        'Nutrition Coach uses signed-in account access. Requests run through Ironforge securely with server-side API keys and daily per-user caps.',
      'settings.claude_api_key.save': 'Open Nutrition Coach',
      'settings.claude_api_key.saved_hint':
        'No Claude API key is stored on this device.',
      'settings.claude_api_key.clear': 'No key to remove',
      'settings.claude_api_key.invalid': 'Sign in to use Nutrition Coach',
      'settings.claude_api_key.saved': 'Nutrition Coach ready',
      'settings.claude_api_key.cleared': 'No local API key stored',
      ...
      'rpe.feel.6': 'Helppo',
      'rpe.feel.7': 'Kohtalainen',
      'rpe.feel.8': 'Raskas',
      'rpe.feel.9': 'Todella raskas',
      'rpe.feel.10': 'Maksimi',
      ...
      'nutrition.setup.body':
        'Kirjaudu sis\u00e4\u00e4n k\u00e4ytt\u00e4\u00e4ksesi ravintocoachia. Claude-pyynn\u00f6t reititet\u00e4\u00e4n turvallisesti Ironforgen kautta, eik\u00e4 Claude API -avainta tallenneta t\u00e4lle laitteelle.',
      'nutrition.setup.save': 'Kirjaudu ja jatka',
      'nutrition.setup.help':
        'Ravintocoach on vain kirjautuneille k\u00e4ytt\u00e4jille. Pyynn\u00f6t kulkevat Supabasen Edge Functionin kautta palvelinpuolen avaimilla ja p\u00e4ivitt\u00e4isill\u00e4 k\u00e4ytt\u00e4j\u00e4kohtaisilla rajoilla.',
      'nutrition.setup.empty': 'Kirjaudu k\u00e4ytt\u00e4\u00e4ksesi ravintocoachia',
      'nutrition.loading.thinking': 'Miettii...',
      'nutrition.loading.analyzing': 'Analysoi ateriaasi...',
      'nutrition.error.no_key':
        'Kirjaudu k\u00e4ytt\u00e4\u00e4ksesi ravintocoachia.',
      'nutrition.error.auth': 'Kirjaudu uudelleen ja yrit\u00e4 uudelleen.',
      'nutrition.error.rate_limit':
        'Pyyntöraja saavutettu \u2014 odota hetki ja yritä uudelleen.',
      'nutrition.error.server': 'Ravintocoach ei ole tilap\u00e4isesti saatavilla.',
      'nutrition.error.api':
      ...
      'settings.claude_api_key.label': 'Turvallinen tilik\u00e4ytt\u00f6',
      'settings.claude_api_key.placeholder': '',
      'settings.claude_api_key.help':
        'Ravintocoach k\u00e4ytt\u00e4\u00e4 kirjautunutta tili\u00e4. Pyynn\u00f6t kulkevat turvallisesti Ironforgen kautta palvelinpuolen avaimilla ja p\u00e4ivitt\u00e4isill\u00e4 k\u00e4ytt\u00e4j\u00e4kohtaisilla rajoilla.',
      'settings.claude_api_key.save': 'Avaa ravintocoach',
      'settings.claude_api_key.saved_hint':
        'Claude API -avainta ei tallenneta t\u00e4lle laitteelle.',
      'settings.claude_api_key.clear': 'Ei poistettavaa avainta',
      'settings.claude_api_key.invalid':
        'Kirjaudu k\u00e4ytt\u00e4\u00e4ksesi ravintocoachia',
      'settings.claude_api_key.saved': 'Ravintocoach valmis',
      'settings.claude_api_key.cleared': 'Paikallista API-avainta ei ole tallennettu',
