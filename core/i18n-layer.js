...
const STRINGS={
  en:{
    ...
    'program.recommend_reason.starred_title':'Why the starred session is recommended',
    ...
    'program.recommend_reason.starred_title':'Miksi tähtimerkitty sessio on suositus',
