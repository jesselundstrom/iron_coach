...
- **React migration**: Gradual island-based migration using React + Vite (not Next.js, not full rewrite)
  ...
  - The bottom navigation and page routing shell remain legacy-controlled through `index.html` + `core/ui-shell.js`; React islands mount inside pages and do not own nav state
